...
def make_plot_project(): ### show the figure with the project name such as 'P1', 'P2'
    ...
    fig = figure(plot_height=350, plot_width=430, title= ticker2.value + ' OVERALL ' + ticker1.value +' Rate', title_location="above", toolbar_location=None,
           x_range=(-0.5, 1.0))
    fig.title.align = 'center'
    fig.add_tools(hover)
    fig.wedge(x=0, y=1, radius=0.4,
    ...
    for i in data_types:
        ...
        p = figure(plot_height=350, plot_width=430, title= ticker2.value+ ' '+ ticker1.value +' Rate of ' + i, title_location="above",toolbar_location=None,
            x_range=(-0.5, 1.0))
        p.title.align = 'center'
        p.add_tools(hover)
        p.wedge(x=0, y=1, radius=0.4,
